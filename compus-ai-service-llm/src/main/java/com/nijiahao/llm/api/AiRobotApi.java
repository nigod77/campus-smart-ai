...
public interface AiRobotApi {
    ...
    Result<AiRobotVo> addRobot(@RequestBody AiRobotApi robot);

    @Operation(summary = "修改机器人" , description = "修改一个机器人")
    @PostMapping("/manage/update")
    Result<AiRobotVo> updateRobot(@RequestBody AiRobotApi robot);
    ...
    PageResult<AiRobotVo> queryRobot(@RequestBody AiRobotApi robot);
